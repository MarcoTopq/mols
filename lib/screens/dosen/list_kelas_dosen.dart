...
class ListKelasDosen extends StatefulWidget {
  @override
  _ListKelasDosenState createState() => _ListKelasDosenState();
}

class _ListKelasDosenState extends State<ListKelasDosen> {
  double fabHeight;
  @override
  void initState() {
    super.initState();
                ...
                ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => ListKelasDosen()));
                    },
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children: [
